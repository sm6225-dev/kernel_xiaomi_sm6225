...
#define QTI_POWER_SUPPLY_TYPE_USB_HVDCP		13
#define QTI_POWER_SUPPLY_TYPE_USB_HVDCP_3	14
#define QTI_POWER_SUPPLY_TYPE_USB_HVDCP_3P5	15
#define QTI_POWER_SUPPLY_TYPE_USB_FLOAT		16
/* Battery Monitor System */
#define QTI_POWER_SUPPLY_TYPE_BMS		17
#define POWER_SUPPLY_TYPE_PARALLEL		18 /* Parallel Path */
#define POWER_SUPPLY_TYPE_MAIN			19 /* Main Path */
#define POWER_SUPPLY_TYPE_WIPOWER		20 /* Wipower */
#define POWER_SUPPLY_TYPE_UFP			21 /* Type-C UFP */
#define POWER_SUPPLY_TYPE_DFP			22 /* Type-C DFP */
#define POWER_SUPPLY_TYPE_CHARGE_PUMP		23
